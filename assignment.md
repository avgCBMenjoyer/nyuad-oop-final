[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/dX7pzS8v)
# Course Project
...
I declare that I have read and completed the above checked item in the list: Pasindu Wickramasinghe, 2024-03-03
...
- *Concept #1*: [Header Files], *File name / Line numbers(s)*: [`vehicle.h`, `ancillary.h`, `customer.h`, `record.h`, `system.h`]
- *Concept #2*: [Modular Functions], *File name / Line numbers(s)*: [`ancillary.cpp`]
- *Concept #3*: [Makefile], *File name / Line numbers(s)*: [makefile]
- *Concept #4*: [Exception Handling], *File name / Line numbers(s)*: [`ancillary.cpp`, Lines(15-54)]
...
- *Concept #1*: [Classes], *File name / Line numbers(s)*: [`vehicle.cpp`, `customer.cpp`, `records.cpp`]
- *Concept #2*: [Abstract Data Types (structs)], *File name / Line numbers(s)*: [`vehicle.cpp`, `customer.cpp`, `records.cpp`]
- *Concept #3*: [Encapsulation], *File name / Line numbers(s)*: [`vehicle.cpp`, `customer.cpp`, `records.cpp`]
- *Concept #4*: [Template Functions], *File name / Line numbers(s)*: [`system.h`, Lines (8-26) ]
